...
function [m,t,exato,y,erro,diverro, logarithm] = rksys(dydt, tspan, y0,potencia)
...
//talvez a parte mais importante do programa
    for i=1:n-1
        ...
        exato(i+1,:)= 2*exp(3*i*h)-2 //Esta eh a função exata! Aqui calcula-se o valor exato da funcao dentro deste loop para cada iteração
    end
//4) SAIDAS DA FUNCAO
...
[m,t,exato,y,e,r, logaritmo_r] = rksys(dydtsys,[50,100],0,2)
